                                    ...
                                    <div class="nk-block-head">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                ...
                                                <div class="nk-block-des">
                                                    <p>Access the Fleet management panel using your Email and Password.</p>
                                                </div>
                                            </div>
                                        </div><!-- .nk-block-head -->
                                        <span id="sign_in_err" class="err-msg">
                                        </span>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-label-group">
                                                ...
                                                <a class="link link-primary link-sm" tabindex="-1" href="forget_pass.php">Forgot Code?</a>
                                            </div>
-->
                                        ...
                                        <div class="form-group">
                                            <button class="btn btn-lg btn-primary btn-block" onclick="signInOperation();">Sign in</button>
                                        </div>
                                        <div class="form-note-s2 pt-4"> New on our platform? <a href="regristration.php">Create an account</a>
                                        </div>
                                    </div>
                                </li>
                            </ul>
